...
import com.canteen.entity.AddressBook;
import com.canteen.service.AddressBookService;
...
public class AddressBookController {
    ...
    public R<List<AddressBook>> list(AddressBook addressBook) {
        ...
        //条件构造器
        LambdaQueryWrapper<AddressBook> queryWrapper = new LambdaQueryWrapper<>();
        queryWrapper.eq(AddressBook::getUserId, addressBook.getUserId()).orderByDesc(AddressBook::getUpdateTime);
    ...
    public R<String> delete(Long ids) {
        ...
        queryWrapper.eq("id", ids).eq("user_id", BaseContext.getCurrentId());
